...
_C.MODEL.ROI_MASK_HEAD.DUAL_MODAL = False
...
_C.MODEL.PANOPTIC.USE_GN = True
_C.MODEL.PANOPTIC.USE_RELU = True
_C.MODEL.PANOPTIC.ATTENTION_FUSION = False
_C.MODEL.PANOPTIC.SEMANTIC_CONSISTENCE = False
_C.MODEL.PANOPTIC.SEMANTIC_CONSISTENCE_LAMBDA = 1.0
