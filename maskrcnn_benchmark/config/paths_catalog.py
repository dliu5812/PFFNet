...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "cell_tcga": (
            "cell-tcga/images",
            "cell-tcga/annotations/celltcga_instance_annotations.json",
        ),

        "cell_fluo": (
            "cell-fluo/images",
            "cell-fluo/annotations/cellfluo_instance_annotations.json",
        ),

        "cell_tnbc": (
            "cell-tnbc/images",
            "cell-tnbc/annotations/celltnbc_instance_annotations.json",
        ),

        "leaf_cvppp_a1": (
            "leaf-cvppp/images",
            "leaf-cvppp/annotations/cvppp_instance_annotations.json",
        ),
